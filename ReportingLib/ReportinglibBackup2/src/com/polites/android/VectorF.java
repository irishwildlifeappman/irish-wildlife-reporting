...
public class VectorF {
	...
	public void set(MotionEvent event) {
		this.start.x = MotionEventCompat.getX(event,0);
		this.start.y = MotionEventCompat.getY(event,0);
		this.end.x = MotionEventCompat.getX(event,1);
		this.end.y = MotionEventCompat.getY(event,1);
	}
