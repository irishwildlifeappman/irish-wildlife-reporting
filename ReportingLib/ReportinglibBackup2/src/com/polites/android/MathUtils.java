...
public class MathUtils {
	...
	public static void midpoint(MotionEvent event, PointF point) {
		float x1 = MotionEventCompat.getX(event,0);
		float y1 = MotionEventCompat.getY(event,0);
		float x2 = MotionEventCompat.getX(event,1);
		float y2 = MotionEventCompat.getY(event,1);
